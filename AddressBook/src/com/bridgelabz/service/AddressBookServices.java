...
public class AddressBookServices implements addressbookinterface {
	...
	static String sourcein = "/home/admin1/FellowShip/AddressBook/src/com/bridgelabz/repository/AdressBook.json";
...
//				+ i.getAddress().getState()));
	...
	public void savedAs() throws JsonGenerationException, JsonMappingException, IOException {
		...
		String format=ScannerUtility.stringScanner();
		System.out.println("A file name with "+fileName+"."+format+" has been created");
		mapper.writeValue(
				new File("/home/admin1/FellowShip/AddressBook/src/"
						+ "com/bridgelabz/repository/" + fileName +"." +format),
				model);
